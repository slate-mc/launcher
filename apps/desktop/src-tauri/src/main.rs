...
use slate_contracts::{
    ...
    InstallJobStateDto, InstallJobSummary, InstallModRequest, InstallModSelection,
    InstallModpackRequest, InstallOperationDto, InstanceArtworkAsset, InstanceArtworkKindDto,
